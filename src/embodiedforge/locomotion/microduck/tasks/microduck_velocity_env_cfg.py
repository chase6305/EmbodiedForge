# Adapted for EmbodiedForge: local namespace; see NOTICE and UPSTREAM.json.
...
from embodiedforge.locomotion.microduck.robot.microduck_constants import MICRODUCK_WALK_ROBOT_CFG
from embodiedforge.locomotion.microduck.tasks import mdp as microduck_mdp
from embodiedforge.locomotion.microduck.tasks.symmetry import PpoWithSymmetryCfg, SYMMETRY_CFG
...
MicroduckRlCfg = RslRlOnPolicyRunnerCfg(
    ...
    algorithm=PpoWithSymmetryCfg(
        class_name="embodiedforge.locomotion.microduck.tasks:MicroduckPPO",
        value_loss_coef=1.0,
